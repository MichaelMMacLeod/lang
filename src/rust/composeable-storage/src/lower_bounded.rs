...
// impl<G: GlobalAlloc> TryPartition<AlignedSlice, AlignedLength<Bytes<usize>>>
//     for LowerBounded<Bytes<usize>, G>
// {
//     type Error = GlobalAllocFailed;

//     fn try_partition(self) -> Result<Partitioned<AlignedSlice, Self>, Self::Error> {
//         let ptr = unsafe {
...
// impl<G: GlobalAlloc> TryMergeTransform<AlignedLength<Bytes<usize>>> for G {
